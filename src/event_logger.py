...
class EventLogger(object):
    ...
    FIELDS = [
        ...
        "deep_closure_active", "deep_closure_dropout_active",
        "deep_closure_dropout_seconds", "closed_seconds", "strong_elapsed_seconds",
        ...
        "yawn_state", "current_yawn_seconds",
        "current_yawn_sustained_seconds", "current_yawn_max_mar",
    ...
    def log_transition(self, mode, previous, new, reason, metrics, fps, gpio):
        ...
        try:
            ...
            row = {
                ...
                "deep_closure_dropout_active": metrics.get("deep_closure_dropout_active"),
                "deep_closure_dropout_seconds": metrics.get("deep_closure_dropout_seconds"),
                ...
                "yawn_state": metrics.get("yawn_state"),
                "current_yawn_seconds": metrics.get("current_yawn_seconds"),
                "current_yawn_sustained_seconds": metrics.get("current_yawn_sustained_seconds"),
                "current_yawn_max_mar": metrics.get("current_yawn_max_mar"),
